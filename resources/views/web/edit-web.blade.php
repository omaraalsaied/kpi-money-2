                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="id" value="{{$web->id}}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="url" type="text" class="form-control @error('url') is-invalid @enderror" name="url" value="{{$web->url}}" placeholder="eg : http://google.com" required>
                                        <div class="help-block with-errors" ></div>
                                        @error('url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
